...
def prepare_data(df):
    ...
    features = [
        ...
        'MA5', 'MA20', 'EMA20', 'EMA50', 'CCI', 
        'ATR', 'Momentum', 'ADX', 'Williams %R', 
        'Volume_MA20', 'ROC', 'CMF', 'OBV'
    ]
...
def train_model_with_hyperparameter_tuning():
    ...
    model = XGBClassifier(random_state=42, use_label_encoder=False, eval_metric='logloss')  # XGBoost 모델
